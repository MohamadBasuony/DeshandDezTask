...
class BadgedButtonItem: UIBarButtonItem {
    ...
    private func setup(image: UIImage? = nil) {
        ...
        self.filterBtn.frame = CGRect(x: -30, y: 0, width: 30, height: 30)
        ...
        self.lblBadge.frame = CGRect(x: 20, y: -6, width: 15, height: 15)
        self.lblBadge.backgroundColor = .main
        self.lblBadge.clipsToBounds = true
        self.lblBadge.layer.cornerRadius = 7
        self.lblBadge.textColor = .black
        self.lblBadge.font = UIFont(name: "Poppins-semiBold", size: 10)
